...
✅ Multivariate (Chronos-2)  
✅ Fast inference  

![](img/chronos_greek.png){width="30%"}
:::
...
[![](img/logo.png){width=30%}](https://github.com/IliasAarab/tsfm)
